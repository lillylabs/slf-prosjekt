			...
			<div class="textwidget">
				...
				<?php if(!empty($feature['more_text'])) : ?>
					<p class="sow-more-text">
						<?php if( !empty( $feature['more_url'] ) ) echo '<a style="color: ' . esc_attr(($feature['container_color'] ? $feature['container_color'] : '#D30013')) . '" href="' . sow_esc_url( $feature['more_url'] ) . '" ' . ( $instance['new_window'] ? 'target="_blank"' : '' ) . '>'; ?>
